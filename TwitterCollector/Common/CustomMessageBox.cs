using TwitterCollector.Forms.ExternalForms;
using System;
...
{
    private static MessageForm message = new MessageForm();
    ...
    public static DialogResult Show(string Text, string Title, eDialogButtons Buttons, Image Image, bool ExitStay)
    {
